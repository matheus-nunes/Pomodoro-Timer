export default function Audios({ chuva, cafeteria, lareira, floresta }) {
  ...
  const chuval = new Audio('https://github.com/matheus-nunes/Pomodoro-Timer/raw/main/soms/Chuva.wav')
  ...
  const florestal = new Audio('https://github.com/matheus-nunes/Pomodoro-Timer/raw/main/soms/Floresta.wav')
  const lareiral = new Audio('https://github.com/matheus-nunes/Pomodoro-Timer/raw/main/soms/Lareira.wav')
